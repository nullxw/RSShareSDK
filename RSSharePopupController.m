...
-(UIView *)product_snsViewWithType:(RSShareSNSType)type{
    ...
    switch (type) {
        ...
        {
            [btn setImage:[UIImage imageNamed:@"RSShareSDK.bundle/RS_qq_icon"] forState:UIControlStateNormal];
            label.text = @"QQ";
        }
            break;
        case RSShareSNSTypeQQZone:
        {
            [btn setImage:[UIImage imageNamed:@"RSShareSDK.bundle/RS_qzone_icon"] forState:UIControlStateNormal];
            label.text = @"QQ空间";
        }
            break;
        case RSShareSNSTypeWeChatSession:
        {
            [btn setImage:[UIImage imageNamed:@"RSShareSDK.bundle/RS_wechat_icon"] forState:UIControlStateNormal];
            label.text = @"微信好友";
        }
            break;
        case RSShareSNSTypeWeChatTimeLine:
        {
            [btn setImage:[UIImage imageNamed:@"RSShareSDK.bundle/RS_wechat_timeline_icon"] forState:UIControlStateNormal];
            label.text = @"微信朋友圈";
        }
            break;
        case RSShareSNSTypeSinaWeibo:
        {
            [btn setImage:[UIImage imageNamed:@"RSShareSDK.bundle/RS_sina_icon"] forState:UIControlStateNormal];
            label.text = @"新浪微博";
        }
            break;
        default:
